...
public final class AvatarSkillUpgradeRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (avatarSkillId_ != 0) {
        output.writeUInt32(5, avatarSkillId_);
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (avatarSkillId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, avatarSkillId_);
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    ...
    internal_static_AvatarSkillUpgradeRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AvatarSkillUpgradeRsp_descriptor,
        new java.lang.String[] { "AvatarGuid", "AvatarSkillId", "Retcode", "OldLevel", "CurLevel", });
  }
