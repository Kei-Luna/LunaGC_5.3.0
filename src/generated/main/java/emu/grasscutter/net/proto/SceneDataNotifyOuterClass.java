...
public final class SceneDataNotifyOuterClass {
  ...
  public interface SceneDataNotifyOrBuilder extends
    ...
    /**
     * <pre>
     *MFPPBNHFHGI PGCIIIHFBDD = 11;
     * </pre>
     *
     * <code>.MapLayerInfo map_layer_info = 7;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int MAP_LAYER_INFO_FIELD_NUMBER = 7;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (mapLayerInfo_ != null) {
        output.writeMessage(7, getMapLayerInfo());
      }
    ...
    public int getSerializedSize() {
      ...
      if (mapLayerInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, getMapLayerInfo());
      }
      {
        int dataSize = 0;
        for (int i = 0; i < sceneTagIdList_.size(); i++) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\007 \001(\0132\r.MapLayerInfo\022\036\n\026level_config_na" +
      "me_list\030\017 \003(\t\022\031\n\021scene_tag_id_list\030\n \003(\r" +
    ...
    internal_static_SceneDataNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SceneDataNotify_descriptor,
        new java.lang.String[] { "MapLayerInfo", "LevelConfigNameList", "SceneTagIdList", });
    emu.grasscutter.net.proto.MapLayerInfoOuterClass.getDescriptor();
  }
