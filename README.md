...
- This tutorial uses fiddler ([video tutorial](https://tutorials.freespyware.store/api/public/dl/viOvXvPH), it may be outdated but the steps are quite similar).
- The fiddler script can be found in the docs folder, or by [this link](https://github.com/Kei-Luna/LunaGC_5.0.0/blob/main/docs/fiddlerscript.txt).
...
- Download the [Resources](https://github.com/Kei-Luna/LunaGC_Resources_5.3.0), make a new folder called `resources` in the downloaded LunaGC folder and then extract the resources in that new folder.
